...
public class AgenciaBancaria {
	...
	public static void transferir() {
		System.out.println("---Numero da conta para enviar transferência--- ");
		...
		if (contaRemetente != null) {
			...
			int numeroContaDestianrio = input.nextInt();

			Conta contaDestinario = encontrarConta(numeroContaDestianrio);
